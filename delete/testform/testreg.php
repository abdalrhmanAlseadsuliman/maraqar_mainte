                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4"  method="post" id="Myform">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4"> <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                                            <div class="form-outline flex-fill mb-0"> <input type="password" id="confirm_password" name="ConfirmPassword" class="form-control" style="text-align: center; font-size: 12px;" placeholder="تأكيد كلمة المرور" required /> </div>
                                        </div>
